    ...
    <Box>
      ...
      >
        ...
        {filteredPosts.length > 0 ? (
          <>
            {/* Filter Controls */}
            <Box sx={{display: "flex", gap: 3, alignItems: "center", justifyContent: "space-between", width: { xs: "300px", sm: "520px" }, p: 1}}>
              <Box>
                <Typography variant="h2" sx={{fontSize: {xs:"1.2rem", sm: "1.5rem"}, mb: 0.5}}>
                  Posts Home
                </Typography>
                <Typography variant="p" sx={{fontSize: {xs: "0.7rem", sm: "0.9rem"}, fontWeight: "200", display: "block"}}>Browsing all posts</Typography>
              </Box>
              <FormControl sx={{flex: 1, flexShrink: 1, maxWidth: "150px"}} size="small">
